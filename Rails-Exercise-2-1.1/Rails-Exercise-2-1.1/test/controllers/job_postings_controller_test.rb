...
class JobPostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_posting" do
    assert_difference("JobPosting.count") do
      post job_postings_url, params: { job_posting: { company: @job_posting.company, location: @job_posting.location, salary: @job_posting.salary, title: @job_posting.title } }
    end
  ...
  test "should update job_posting" do
    patch job_posting_url(@job_posting), params: { job_posting: { company: @job_posting.company, location: @job_posting.location, salary: @job_posting.salary, title: @job_posting.title } }
